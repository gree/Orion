...
$apiConfig = array(
    ...
    //'application_name' => $this->orion_config['GOOGLE_OAUTH_APPLICATION_NAME'],
    ...
    //'oauth2_redirect_uri' => $this->orion_config['BASE_URL'] . 'index.php/authenticate/googleoauth2callback',
    ...
    'site_name' => $this->orion_config['GOOGLE_OAUTH_1_SITE_NAME'],
